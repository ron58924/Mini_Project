                  ...
                  <div className="modal-body p-4">
                    <div className="row g-3">
                      ...
                      <div className="col-md-6">
                        ...
                        <input type="password" name="password" className="form-control" placeholder={isEditing ? "ปล่อยว่างถ้าไม่เปลี่ยน" : "กำหนดรหัสผ่าน"} value={formData.password} onChange={handleInputChange} required={!isEditing} />
                      </div>
                      <div className="col-md-6">
